...
function nd_codewithme_enqueue_scripts() {
    ...
    $translation_array = array(
        "email_placeholder" => esc_attr__( 'Enter your email address here', 'nd_codewithme' ),
...
function nd_codewithme_theme_setup() {
    ...
    */
    ...
    register_nav_menus( array(
        'header'   => esc_html__( 'Display this menu in Header', 'nd_codewithme' ),
        'footer'   => esc_html__( 'Display this menu in Footer', 'nd_codewithme')
    ) );
...
function nd_codewithme_register_sidebars() {
    ...
    register_sidebar( array(
        'name'          => esc_html__( 'Footer Section One', 'nd_codewithme' ),
        'id'            => 'footer-section-one',
        'description'   => esc_html__( 'Widgets added here would appear inside the first section of the footer', 'nd_codewithme' ),
    ...
    register_sidebar( array(
		'name'          => esc_html__( 'Footer Section Two', 'nd_codewithme' ),
		'id'            => 'footer-section-two',
		'description'   => esc_html__( 'Widgets added here would appear inside the second section of the footer', 'nd_codewithme' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h4 class="widget-title">',
		'after_title'   => '</h4>',
